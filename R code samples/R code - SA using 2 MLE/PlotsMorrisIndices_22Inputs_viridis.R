...
for (loopCnt in (1:length(versions)))  {
  ...
  titleTxt <- paste0("Morris analysis using 22 machine learning inputs - Summary ")
      ...
      morris_Plot_EmergenceDAS <- ggplot(Emergence_df, aes(x=mu.star, y=sigma, color = input, label=input, shape= model )) +
      ...
      outputPlot <- paste0("./Reports/Figures/MegaMorris22_Summary_x.png")
