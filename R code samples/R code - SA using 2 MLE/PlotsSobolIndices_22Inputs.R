#Plots of Sobol indices (21 inputs) generated by ML emulators
#============================================================================
# Random Forest and ANN emulators for 6 output targets by 21 Inputs
#   across 3 locations [1 Sowing = 2; 1 sampling level = 100000 samples]
...
ANN_megainputsTestFile <- "ANN_MegaSobolTest_b.csv"
RF_megainputsTestFile <- "RF_MegaSobolTest_b.csv"
...
#ANN models
sourceFile <- paste0(dataPath,ANN_megainputsTestFile)
ann_mega_df <- read.csv(sourceFile)

#RF models
sourceFile <- paste0(dataPath,RF_megainputsTestFile)
...
png('./Reports/Figures/MegaSobol_22Inputs_VaryingLat.png', width=26, height=18, units='cm', res=300)
print(
    ...
    sobol_Plot_mega <- ggplot(allScenarios_df, aes(x=input, y=original, color = index )) +
           ...
           # scale_color_discrete(name = "Index")+
            ...
            labs(title = "Sobol Analysis of 22 machine learning inputs : Latitude variable")+
            xlab("Input")+
