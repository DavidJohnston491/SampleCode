...
ANN_megainputs <- "ANN_21MegaSobolTest_FixedLat_"
RF_megainputs <- "RF_21MegaSobolTest_FixedLat_"
...
for (loopCnt in (1:length(versions)))  {
  ...
  titleTxt <- paste0("Sobol Analysis of 21 machine learning inputs for ",versions[loopCnt]," fixed Lat")
  outputPlot <- paste0("./Reports/Figures/MegaSobol_21Inputs_FixedLat_" ,versions[loopCnt],".png")
