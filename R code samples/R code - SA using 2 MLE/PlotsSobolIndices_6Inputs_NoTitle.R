...
#Emerald
outputFile <- paste0(outputPath,Emerald_graph1Name,"_NoTitle.png")
...
#Gunnedah
outputFile <- paste0(outputPath,Gunnedah_graph1Name,"_NoTitle.png")
png(outputFile, width=18, height=25, units='cm', res=300)
print(
    # ggplot2 plot with confidence intervals    
...
#Horsham
outputFile <- paste0(outputPath,Horsham_graph1Name,"_NoTitle.png")
png(outputFile, width=18, height=25, units='cm', res=300)
print(
    # ggplot2 plot with confidence intervals    
