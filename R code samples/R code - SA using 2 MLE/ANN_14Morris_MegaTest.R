...
#
  ...
  for (target in c("EmergenceDAS","FloweringDAS","PoddingDAS","MaturityDAS","Biomass","GrainWt")) {
    ...
    x <- morris(model = NULL, factors = 14, r = 100,
                design = list(type = "oat", levels = 10, grid.jump = 5),
                binf = c(120,400,0,100,30,0.2,260,90,0,0,0,10.7,10.9,10.6), 
                bsup = c(140,600,250,200,40,1,340,200,18.8,16.8,19.2,33,33.2,36), 
                scale = TRUE)
