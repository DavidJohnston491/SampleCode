...
outputCSVFile <- "Act_Pred_All_TestSites_3ML.csv"
#===========================================
...
png('HexBinPlots_Models_TestStites_v4_3ML_revised.png', width=12, height=30, units='cm', res=300)
   print(
...
png('Legend_HexBinPlots_TestStites_3ML.png', width=12, height=15, units='cm', res=300)
print(
