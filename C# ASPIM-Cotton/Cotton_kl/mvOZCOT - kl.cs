...
namespace ManagedComponent.MvOZCOT
{
    ...
    public class mvOZCOTClass : TBaseComp
    {
       ...
       // private const int PROP_rootDepth_mm = PROP_START_INDEX + 167;
       ...
       // private double pod_res_n;
        ...
        public void ozcot_emerg()
		{
			...
			if (initial_call == true)      // first call of season
			{
                ...
                rootGrowthRateDD = 0.5;      //use a constant for now  0.5 * 60 DD @ 5 cm planting depth = 30mm root growth
            ...
            dlt_rootDepth = rootGrowthRateDDAdj * dd;
            rootDepth_mm += dlt_rootDepth;
  ...
  ////          }
       ...
       // public void ozcot_n_fertilise(double applied, double availn, double applied_avail)
        ...
        public void ozcot_solwat()
        {
            ...
            ozcot_removeEp_swbal();                // removes ep & es from layers using kL values
        ...
        // ====================================================================
        public void ozcot_removeEp_swbal()
        {
